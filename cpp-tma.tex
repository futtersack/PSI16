%%
%% This is file `cpp-tma.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% testmath.dtx  (with options: `cpp')
%% ====================================================================
%% $Id: testmath.dtx,v 1.23 2003/06/29 23:38:16 uwe Exp $
%% ====================================================================
%% This paper is a sample adapted from the \AmS-\LaTeX{} document
%% "testmath.tex" to illustrate the use of document class \texttt{w-art} and
%% publication-specific class options for that class for
...
\Year{2003}
%%
%%    First and last pagenumber. If the option 'autolastpage' is set (default)
%%    the second argument may be left empty.
\pagespan{3}{}
%%    Dates will be filled in by the publisher. The 'Revised' and
%%    'Dateposted' (electronically published) entry may be left empty.
...
%% Please do not enter footnotes or \inst-notes into
%% the optional argument. The optional argument goes into the header.
%% If there is only one address the marker \inst{x} and (x) may be omitted.

\author[Sh. First Author]{L. First Author\footnote{Corresponding author:
    e-mail: {\sf x.y@xxx.yyy.zz}, Phone: +00\,999\,999\,999, Fax:
    +00\,999\,999\,999}\inst{1}} \address[\inst{1}]{First address}

%%    Information for second author
\author[Sh. Second Author]{L. Second Author\inst{1,2}}
\address[\inst{2}]{Second address}

%%    Information for third author
\author[Sh. Third Author]{L. Third Author\inst{2}}

%%    \thanks will become a 1st page (unnumbered) footnote.
%%    Multiple \thanks are possible. You may use it for the
...
%% The maketitle command must follow after the abstract.
\maketitle
...
%% {\textsc{First Author}, A Short Title}

%% \renewcommand{\rightmark}
%% {\textsc{First Author} and \textsc{Second Author}, A Short Title}

%% \renewcommand{\rightmark}
%% {\textsc{First Author} et al., A Short Title}

\renewcommand{\rightmark}
{\textsc{WILEY-VCH Verlag Berlin GmbH}: Sample paper for the \pkg{w-art} class}
